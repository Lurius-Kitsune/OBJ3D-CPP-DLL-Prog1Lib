...
namespace Tools
{
	...
	public:
		...
		Stack(const initializer_list<Type>& _list)
		{
			first = nullptr;
			last = nullptr;
			size = 0;
	...
	public:
		...
		Type Pop()
		{
			...
			Node<Type>* _newLast = last->previous;
			_newLast->next = nullptr;
	...
	public:
		...
		void operator += (Stack<Type> _linkedList)
		{
		...
		friend ostream& operator << (ostream& _stream, const Stack<Type>& _object)
		{
